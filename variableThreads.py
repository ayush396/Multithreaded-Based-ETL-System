...
def transform(fileName):
    inputputFileName = "Split(10)-30lakh/"  + fileName
    outputFileName = "dir(10)-30lakh/" + fileName
...
allFiles = os.listdir("Split(10)-30lakh/")
...
for fileName in allFiles:
    ...
    while True:
        ...
        if threading.activeCount() - activeThreads + 1 <=10:
            break
        time.sleep(0.05)
